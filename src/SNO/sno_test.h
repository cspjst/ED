...
void test_any(void) {
    ...
    sub = sno_view(NULL, "A");
    assert(!sno_any(&sub, sno_bind("A")) && !sub.begin && sub.end == "A");
...
void test_notany(void) {
    ...
    sub = sno_view(NULL, "A");
    assert(!sno_notany(&sub, sno_bind("A")) && !sub.begin && sub.end == "A");
    ...
    char buf7[] = "FIELD,REST";
    sub = sno_bind(buf7);
    while (sno_notany(&sub, sno_bind(","))) ;
    assert(*sub.begin == ',');
    
    sub = sno_view(&buf7[2], &buf7[0]);
    orig = sub.begin;
...
void test_span(void) {
    ...
    sub = sno_view(NULL, "A");
    assert(!sno_span(&sub, sno_bind("A")) && !sub.begin && sub.end == "A");
...
void test_break(void) {
    ...
    sub = sno_view("A", NULL);
    assert(sno_break(&sub, sno_bind(",")) && sub.begin == "A" && !sub.end);
    
    sub = sno_view(NULL, "A");
    assert(!sno_break(&sub, sno_bind(",")) && !sub.begin && sub.end == "A");
...
void test_skip(void) {
    ...
    sub = sno_view("A", NULL);
    assert(sno_skip(&sub, sno_bind(" ")) && sub.begin == "A" && !sub.end);
    
    sub = sno_view(NULL, "A");
    assert(!sno_skip(&sub, sno_bind(" ")) && !sub.begin && sub.end == "A");
...
void test_int(void) {
    ...
    sub = sno_view("123", NULL);
    orig = sub.begin;
    assert(!sno_int(&sub, &n) && sub.begin == orig);
    
    sub = sno_view(NULL, "123");
    assert(!sno_int(&sub, &n) && !sub.begin && sub.end == "123");
}
